...
class ModalCedulaAutoresComponent extends Component
{
    ...
    public function LimpiaModalAutores(){
        ...
        $this->reset('ModAut_nombre','ModAut_apellido1','ModAut_apellido2','ModAut_url','ModAut_autorname',
            'ModAut_correo', 'ModAut_tel','ModAut_comunidad', 'ModAut_institu','ModAut_orcid','ModAut_scopus',
            'ModAut_isni', 'ModAut_web', 'ModAut_mailpublic','ModAut_usrsist');
        // $this->ModAut_nombre='';
    }
    ...
    public function GuardarDatos(){
        ...
        $datos=[
            ...
            'caut_comunidad'=>$this->ModAut_comunidad,
