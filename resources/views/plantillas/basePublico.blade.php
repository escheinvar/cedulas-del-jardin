                    ...
                    <div class="offcanvas-body">
                        @hasSection('MenuPublico')
                            <ul class="navbar-nav justify-content-end flex-grow-1">
                                ...
                                <!-- Los jardines-->
                                <li class="nav-item">
                                    <a class="nav-link @if(request()->path() == 'jardiness') active @endif" href="/jardiness">
                                        Los Jardines
                                    </a>
                                </li>
                                    ...
                                    @if(array_intersect(['admin','editor','webmaster'],session('rol')))
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li> <hr class="dropdown-divider"> </li>
                                                <li><a class="dropdown-item @if(request()->path() == 'reporte_cedulas') active @endif" href="/reporte_cedulas">Tablero</a></li>
