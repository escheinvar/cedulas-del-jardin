                ...
                <div class="modal-body" >
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                @if($listasp_reino!='')
                                    ...
                                    @if($listasp_ConCatalogo=='1')
                                        ...
                                        <!-- Selecciona especie -->
                                        <div class="col-12 col-md-6 form-group">
                                            <label for="listasp_scname" class="form-label">Nombre científico:<red>*</red></label>
                                            <select wire:model.live="listasp_scname" id="listasp_scname" class="@error('listasp_scname') is-invalid @enderror form-select">
                                            ...
                                            <div class="form-text"></div>
                                            @error('listasp_scname')<error>{{ $message }}</error>@enderror
                                        </div>
                                    @else
                                    ...
                                    <div class="col-12 col-md-6 form-group">
                                        ...
                                        <input wire:model="listasp_var" id="listasp_var" class="@error('listasp_var') is-invalid @enderror form-control"  type="text">
                                        <div class="form-text"></div>
                    ...
                    <div class="row"  wire:loading.attr="disabled">
                        ...
                        <div class="col-12  my-1 form-group">
                            <label for="listasp_razon" class="form-label">Explicación o razón de estar en la lista<red>*</red></label>
