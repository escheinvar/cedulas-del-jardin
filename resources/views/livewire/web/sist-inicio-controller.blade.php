...
<div>
    ...
    <div class="row justify-content-around py-5">
        <p>Las Cédulas del Jardín es una plataforma de código abierto, gratuita, colaborativa y multilingüe,
        ...
        <p>Su objetivo principal es generar un punto de encuentro en el que se pueda valorar, conocer, preservar y reconocer estos saberes locales
        ...
        <p>Si quieres participar, revisa nuestra sección &quot;Cómo participar&quot;.</p>
        ...
        <div class="row justify-content-around py-5">
            ...
            <p>Los Jardines Etnobiológicos tienen que visibilizar, resguardar, difundir y sobre todo, acompañar, reconocer y dar lugar
                ...
                incluyendo las lenguas en las que son generadas.  La
                ...
                documentación por parte de las propias comunidades debe ser su prioridad.</p>


            <p>"Las cédulas del jardín" es una herramienta de código abierto diseñada para facilitar elaboración, traducción y
            publicación en línea de información etnobiológica en lenguas originarias.</p>
        </div>
        <div class="col-sm-auto col-md-12 px-4 mb-4" style="text-align: justify;">
            <p>El desarrollo del sistema, se inicia en 2025 como parte de una línea de investigación de los Investigadores por México de la
                ...
                de los saberes ancestrales de los pueblos originarios y desconolinzación del saber.   Se genera bajo el proyecto Secihty IxMx/7269
                y ha participado de los proyectos Renajeb-2023-21 y Divulgación 2024-1114 financiados por el Consejo Nacional de Humanidades, Ciencias y Tecnologías (Conahcyt) y la
    ...
    <div class="row justify-content-around py-5">
        <div class="col-sm-auto col-md-12 px-4 mb-4" style="text-align:justify;">
            ...
            <li>Multilingüe. Cuenta con la capacidad de interactuar con traductores a distancia para generar traducciones
                de cada una de las cédulas a diversas lenguas originarias. Cuenta con tclado de caracteres especiales requeridos para diferentes lenguas.</li>

            <li>Es libre y abierto. Los visitantes pueden acceder a la información de manera libre y gratuita, sin necesidad de registrarse y pueden
                colaborar con información desde la sección "yo tengo algo que aportar", al final de cada cédula.</li>

            <li>Respeta la oralidad. Permite incorporar inormación audible o asociar archivos de audio en las cédulas para preservar
                la tradición oral, así como para facilitar la traducción e inclusión de lenguas carentes de escritura o de compleja escritura .</li>

            <li>Evita el extractivismo. Reconoce y nombra a cada uno de los pueblos o cumunidades como las propietarias,
                preservadoras y garantes del conocimiento.</li>

            <li>Es colaborativo. Cuenta con diversos roles que facilitan la interacción para la creación, edición, revisión y publicación
                de cédulas de información. </li>

            <li>Interactiva. Incluye funcionalidades para agregar información en formato de texto, audio, imágenes o videos.</li>
            ...
            <li>Catalogable. Genera una dirección URL única y fija para cada una de las cédulas de documentacion a las cuales se puede
                ...
                o mediante la asignación de un numero DOI.</li>
            ...
            <li>Incorpora redes. Permite incorporar referencias a canales, publicaciones y videos de documentación externa
                generadas por el público en diversas redes sociales.</li>

            <li>Gestión multi-jardín. Permite registrar uno o más jardines virtuales en un mismo sistema, manteniendo la independencia en la asignación de roles y
                administración de contenidos, pero ahorrando recursos de infraestructura</li>

            <li>Colaborativo. Al incluir varios jardines virtuales, permite ampliar la información referente a un mismo tema,
                avisando al visitante, cuando hay otras cédulas relacionadas al mismo tema en otros jardines,
                lo que promueve la colaboración entre jardines y comunidades.</li>

             <li>Accesible. Al ser un sistema basado en la web, permite el acceso a las cédulas desde cualquier dispositivo con conexión a internet,
            ...
            <li>Con compromiso Ético. El sistema se alinea al <a href="">Código de Ética para la
            investigación, la investigación-acción y la colaboración etnocientífica en América Latina</a>, aprobado por la
            Asamblea General de la Sociedad Latinoamericana de Etnobiología en octubre de 2016
            en Popayán, Colombia.</li>
        </div>
    </div>
    ...
    <div class="row justify-content-around py-5">
        <div class="col-sm-auto col-md-9 px-4 mb-4" style="text-align:justify;">
            ...
            <p>El contenido de las cédulas se distribuye bajo la <a href="https://www.gnu.org/licenses/fdl-1.3.html" target="new">Licencia de Documentación Libre de GNU</a> Versión 1.3, por lo que se concede permiso
                para copiar, distribuir y/o modificar los documentos siempre y cuando se citen las fuentes originales.</p>
