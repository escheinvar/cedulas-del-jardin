...
<div class="formato-grande">
    ...
    <!-- -------------------- paso 1 -------------------- -->
    <div class="Manual">
        <div class="@if($paso1=='0') cabezaManual @else cabezaManual2 @endif" wire:click="VerONoVer('paso1')">
            1.- Revisar norma editorial
            <i id="saleicon_verNormas" class="bi @if($paso1=='0') bi-arrow-bar-down @else bi-arrow-bar-up @endif" ></i>
        </div>
        @if($paso1=='1')
            <div class="cuerpoManual" id="sale_verNormas">
                <ol type="1">
                    <li>Lee la <a href="/normaeditorial" target="_blank">norma editorial</a> para confirmar que lo que deseas publicar cumpla con los criterios de publicación.</li >
                    <li>Revisa que los textos, imágenes y demás elementos cumplan con los criterios de publicación ahí establecidos.</li>
                </ol>
            </div>
        @endif
    </div>
    ...
    <!-- -------------------- paso 2 -------------------- -->
    <div class="Manual">
        <div class="@if($paso2=='0') cabezaManual @else cabezaManual2 @endif" wire:click="VerONoVer('paso2')">
            2.- Genera una cuenta en Las Cédulas del Jardín.
            <i id="saleicon_verCrear" class="bi @if($paso2=='0') bi-arrow-bar-down @else bi-arrow-bar-up @endif" ></i>
        </div>
        @if($paso2=='1')
    ...
    <!-- -------------------- paso 3 -------------------- -->
    <div class="Manual">
        <div class="@if($paso3=='0') cabezaManual @else cabezaManual2 @endif" wire:click="VerONoVer('paso3')">
            3.- Ingresa al portal.
            <i id="saleicon_verCrear" class="bi @if($paso3=='0') bi-arrow-bar-down @else bi-arrow-bar-up @endif" ></i>
        </div>
        @if($paso3=='1')
    ...
    <!-- -------------------- paso 4 -------------------- -->
    <div class="Manual">
        <div class="@if($paso4=='0') cabezaManual @else cabezaManual2 @endif" wire:click="VerONoVer('paso4')">
            4.- Solicita el rol de autor
            <i id="saleicon_verCrear" class="bi @if($paso4=='0') bi-arrow-bar-down @else bi-arrow-bar-up @endif" ></i>
        </div>
        @if($paso4=='1')
    ...
    <!-- -------------------- paso 5 ----------------------- -->
    <div class="Manual">
        <div class="@if($paso5=='0') cabezaManual @else cabezaManual2 @endif" wire:click="VerONoVer('paso5')">
            5.- Descarga y llena el formato de envío y la solicitud de publicación
            <i id="saleicon_verCrear" class="bi @if($paso5=='0') bi-arrow-bar-down @else bi-arrow-bar-up @endif" ></i>
        </div>
        @if($paso5=='1')
            <div  class="cuerpoManual" id="sale_verFormatos">
                <b><u>Descarga y llena el formato de envío</u></b>
                <ol type="1">
                    <li>Luego de ingresar al portal, desde la págnia inicial (o home), el autor de correspondencia deberá
                        busca y descarga el formato de envío (o descargarlo desde <a href="/NormaEditorial_CartaSol-FormatoEnvio.docx" target="_new">aquí</a>)</li>
                    <li>
                ...
                <ol type="1">
                    <li>Luego de ingresar al portal, desde la página inicial (o home), el autor de correspondencia deberá
                        buscar y descargar la carta de solicitud (o descargarla desde <a href="/NormaEditorial_CartaSol-FormatoEnvio.docx" target="_new">aquí</a>).</li>
    ...
    <!-- -------------------- paso 6 -------------------- -->
    <div class="Manual">
        <div class="@if($paso6 == '0') cabezaManual @else cabezaManual2 @endif"  wire:click="VerONoVer('paso6')">
            6.- Iniciar con las revisiones
            <i id="saleicon_verCrear" class="bi @if($paso6=='0') bi-arrow-bar-down @else bi-arrow-bar-up @endif" ></i>
        </div>
        @if($paso6=='1')
    ...
    <!-- -------------------- paso 7 -------------------- -->
    <div class="Manual">
        <div class="@if($paso7==0) cabezaManual @else cabezaManual2 @endif"  wire:click="VerONoVer('paso7')">
            7.- Inicia el proceso de publicación
            <i id="saleicon_verCrear" class="bi @if($paso7=='0') bi-arrow-bar-down @else bi-arrow-bar-up @endif" ></i>
        </div>
        @if($paso7=='1')
